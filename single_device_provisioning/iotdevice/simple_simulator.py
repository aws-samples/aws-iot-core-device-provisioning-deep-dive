...
while True:
    ...
    cmd = f"mosquitto_pub --cafile rootcert.pem --cert FPC-device-{DOCKER_ID}.certificate.pem --key FPC-device-{DOCKER_ID}.private.key -h {ENDPOINT} -p 8883 -q 1 -t {topic} -I anyclientID --tls-version tlsv1.2 -m '{payload}' -d"
    print (cmd)
